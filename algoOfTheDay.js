...
function divisibleByThree(pokemon) {
    ...
    for (let i = 0; i < pokemon.length; i++) {
        let loop = pokemon[i];
        // console.log(loop.id)
        if (loop.id % 3 === 0) console.log(loop) //Completed 1
    }
}
...
function moreThanOneType(pokemon) {
    ...
    for (let i = 0; i < pokemon.length; i++) {
        let loop = pokemon[i];
        // console.log(loop.id)
        if (loop.types.length > 1) console.log(loop) //Completed 2
    }
}
...
function poisonType(pokemon) {
    ...
    for (let i = 0; i < pokemon.length; i++) {
        let loop = pokemon[i];
        // console.log(loop.id)
        if (loop.types[0] === 'poison' || loop.types[1] === 'poison') console.log(loop.name) //completed 3
    }
